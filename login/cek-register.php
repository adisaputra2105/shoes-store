...
$result = mysqli_query($koneksi, "INSERT INTO pelanggan (nama_pelanggan,username_pelanggan,password_pelanggan,tlp_pelanggan) VALUES( '$name','$username','$password','$no_tlp')");
if ($result == true) {
